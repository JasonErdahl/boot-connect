        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <input name="loginID" onChange={this.handleinputchange} className="modalInput" type="text" placeholder="Username" />
              <input name="Password" onChange={this.handleinputchange} className="modalInput" type="password" placeholder="Password" />
              <br></br><br></br>
              <input name="subscriber" onChange={this.handleinputchange} type="checkbox" value="1" /> Subscribe to our newsletters
          </div>
